...
import { InputDeleteCompanySchema, OutputDeleteCompanyDTO } from "../dtos/company/InputDeleteCompany.dto";
...
export class CompaniesController {
    ...
    public deleteCompany = async (req: Request, res: Response) => {
        ...
        try {
            ...
            const output: OutputDeleteCompanyDTO = await this.companiesBuisness.deleteCompany(input)
